      ...
      <div className="max-w-2xl w-full">
        <header className="mb-10">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground">
            Track your commits, tasks, and generate AI-powered weekly summaries effortlessly. Streamline your workflow and gain insights into your development journey.
          </p>
        </header>
